      ...
      <section className={styles.section}>
        ...
        <div className={styles.newGrid}>
          {visible.map(ep => {
            ...
            return (
              <div key={ep.id} className={`${styles.newCard} ${scheduled ? styles.cardScheduled : ''}`} onClick={() => openEpisode(ep)}>
                <div className={styles.newThumb}>
                  ...
                  {ep.duration && <div className={styles.durationBadge}>{ep.duration}</div>}
                  {scheduled && isAdmin && <div className={styles.scheduledBadge}><Lock size={9}/> Programado</div>}
