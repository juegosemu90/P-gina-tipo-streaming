...
// Selecciona 3 episodios aleatorios fijos para el mes actual
          ...
          <div className={styles.featuredGrid}>
            {featured.map((ep, i) => {
              const thumb = ep.thumbnail || (getYoutubeId(ep.youtubeUrl)
                ...
                : null)
              return (
                <div key={ep.id} className={`${styles.featuredCard} ${i === 0 ? styles.featuredMain : ''}`} onClick={() => setSelected(ep)}>
                  ...
                  <div className={styles.featuredInfo}>
                    ...
                    {getPubDate(ep) && (
                      <div className={styles.meta}><Calendar size={11} /> {getPubDate(ep)}</div>
                    )}
                  </div>
                </div>
              )
