      ...
      <div className={styles.detailWrapper}>
        ...
        <div className={styles.mobileDetailOnly}>
          ...
          <div className={styles.mTagsRow}>
            ...
            <span className={styles.mTag}>{PAGES.length} TEMPORADA{PAGES.length !== 1 ? 'S' : ''}</span>
          </div>
        ...
        <>
          ...
          <section className={styles.catSection}>
            ...
            <div className={styles.catSlider}>
              {PAGES.map(p => {
                const img = pageBannerImg(p)
                return (
                  <div key={p} className={styles.catCard} onClick={() => setActivePage(p)}>
                    <div className={styles.catImgWrap}>
                      {img
                        ? <img src={img} alt={`Bloque ${p}`} className={styles.catImg} />
                    ...
                    <div className={styles.catInfo}>
                      ...
                      <span className={styles.catMeta}>{countByPage(p)} episodios</span>
                    </div>
                  </div>
                )
              })}
            ...
            <section className={styles.newSection}>
              ...
              <div className={styles.newSlider}>
                {continueWatching.map(ep => {
                  ...
                  return (
                    <div key={ep.id} className={styles.newCard16} onClick={() => openEpisode(ep)}>
