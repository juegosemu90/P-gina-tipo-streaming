              ...
              return (
                <div key={ep.id} className={`${styles.episodeRow} ${sched ? styles.episodeRowScheduled : ''}`} onClick={() => openEpisode(ep)}>
                  <div className={styles.episodeThumbWrap}>
                    {thumb ? <img src={thumb} alt={ep.title} className={styles.episodeThumb} /> : <div className={styles.episodeThumbFallback}>🌹</div>}
                  ...
                  <div className={styles.episodeInfo}>
                    <div className={styles.episodeTitleRow}>
                      <span className={styles.episodeNum} style={{ color }}>{ep.episode || '?'}</span>
              ...
              return (
                <div key={ep.id} className={styles.searchResult} onClick={() => openEpisode(ep)}>
                  <div className={styles.searchThumbWrap}>
                    {thumb ? <img src={thumb} alt={ep.title} className={styles.searchThumb} /> : <div className={styles.searchThumbFallback}>🌹</div>}
              ...
              {SEASONS.map(s => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className={styles.seasonBtnCount}>
                      {count > 0 ? `${count} ep.` : 'Próx.'}
                    </span>
                  </button>
                )
              })}
          ...
          {featured.length > 0 && (
            <section className={styles.section}>
              ...
              <div className={styles.slider} ref={sliderRef}>
                {featured.map(ep => {
                  const thumb = ep.thumbnail || (getYoutubeId(ep.youtubeUrl) ? `https://img.youtube.com/vi/${getYoutubeId(ep.youtubeUrl)}/hqdefault.jpg` : null)
                  return (
