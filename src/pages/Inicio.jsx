...
export default function Inicio({ playerConfig, searchOpen, setSearchOpen, onWatchingChange }) {
  ...
  return (
    <div className={styles.wrapper}>
      ...
      {!searchOpen && (
        <>
          {/* ── Secciones — acceso a categorías (próximamente) ── */}
          <button className={styles.sectionsLink} onClick={() => {}}>
            Secciones <span className={styles.sectionsArrow}>›</span>
          </button>
                    ...
                    <div key={ep.id} className={styles.featuredCard} onClick={() => openEpisode(ep)}>
                      <div className={styles.featuredThumb}>
                        ...
                        <div className={styles.continueProgressTrack}>
                          <div className={styles.continueProgressFill} style={{ width: `${pct}%` }} />
                        </div>
                      </div>
