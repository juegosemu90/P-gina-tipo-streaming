        ...
        <>
          ...
          <section className={styles.catSection}>
            ...
            <div className={styles.catSlider}>
              ...
              <FadeInCard className={styles.catCard} delay={0} onClick={() => setActivePage(1)}>
                <div className={styles.catImgWrap}>
                  {pageBannerImg(1)
                    ? <img src={pageBannerImg(1)} alt="La Rosa de Guadalupe" className={styles.catImg} />
              ...
              {extraCats.map((cat, i) => (
                <FadeInCard key={cat.id} className={styles.catCard} delay={(i + 1) * 60}>
                  <div className={styles.catImgWrap}>
                    {cat.thumbnail
