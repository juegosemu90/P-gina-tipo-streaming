...
export default function Temporadas({ playerConfig, onEpisodeOpen }) {
  ...
  // Detectar episodio en URL al cargar — solo si esta página está activa
  useEffect(() => {
    ...
    if (match) {
      ...
      // Solo abrir si pertenece a la temporada activa (evita doble apertura)
      if (ep && !isScheduled(ep)) {
        const epSeason = parseSeason(ep.season)
        if (epSeason !== null) {
