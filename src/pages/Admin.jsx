...
export default function Admin({ user, onLogout }) {
  ...
  const handleEdit = (ep) => {
    ...
    setForm({ title: ep.title||'', description: ep.description||'', youtubeUrl: ep.youtubeUrl||'',
      thumbnail: ep.thumbnail||'', episode: ep.episode||'',
            ...
            <div className={styles.modalCard} onClick={e => e.stopPropagation()}>
              ...
              <div className={styles.modalBody}>
                <div className={styles.grid}>
                  ...
                  <input className={styles.input} name="episode"    placeholder="Número de episodio (ej. 456)" type="number" value={form.episode} onChange={handleChange} />
                </div>
