    ...
    <div className={styles.wrapper}>
      ...
      <div className={styles.card}>
        ...
        <div className={styles.grid}>
          ...
          <input className={styles.input} name="thumbnail"  placeholder="Link de miniatura (imagen)" value={form.thumbnail}  onChange={handleChange} />
            ...
            {episodes.map(ep => (
              <div key={ep.id} className={`${styles.epRow} ${editingId === ep.id ? styles.epRowActive : ''}`}>
                ...
                <div className={styles.epActions}>
                  <button className={styles.editBtn} onClick={() => handleEdit(ep)} title="Editar">
                    <Pencil size={14} />
                  </button>
                  <button className={styles.deleteBtn} onClick={() => handleDelete(ep.id)} title="Eliminar">
                    <Trash2 size={14} />
                  </button>
                </div>
              </div>
