...
export default function VideoPlayerAdvanced({ url, title, onBack, playerConfig = {}, episodeId, startAt = 0, forceShowControls = false }) {
  const {
  ...
  const resetHideTimer = useCallback(() => {
    ...
    if (playing && !forceShowControls) {
      hideTimer.current = setTimeout(() => setShowControls(false), 3000)
    }
  }, [playing, forceShowControls])
  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* ── Barra inferior — 2 filas: progreso arriba, controles abajo ── */}
        <div className={styles.bottomBar}>

          {/* Fila 1: tiempo + barra de progreso + tiempo restante */}
